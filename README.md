...
## Analysis Performed
- Time-domain analysis using step response
- Stability analysis using root locus
- Frequency-domain analysis using Bode plots
- Evaluation of gain and phase margins
...
### Step Response
![Step Response](https://github.com/chittemvasanthkumar/control-systems-matlab/blob/main/plots/Bode%20Plot.png)
